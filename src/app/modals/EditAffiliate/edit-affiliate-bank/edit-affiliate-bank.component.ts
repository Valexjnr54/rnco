...
@Component({
  selector: 'app-edit-affiliate-bank',
  templateUrl: './edit-affiliate-bank.component.html',
  styleUrls: ['./edit-affiliate-bank.component.scss']
})
export class EditAffiliateBankComponent implements OnInit {
@Input() User:object
  constructor(
