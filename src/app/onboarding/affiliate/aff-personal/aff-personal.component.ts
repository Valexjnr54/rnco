...
@Component({
selector: 'app-aff-personal',
templateUrl: './aff-personal.component.html',
styleUrls: ['./aff-personal.component.scss']
})
export class AffPersonalComponent implements OnInit {
// hide password
hidePassword = true;
...
constructor(
  ...
  if(!this.firstName  && !this.lastName && !this.phoneNumber  && !this.email  && !this.login&& !this.dateOfBirth && !this.password && !this.confirmPassword){
     this.notification.alertInfo("Fields cannot be empty")
       ...
       this.notification.alertInfo("First Name is required")
         ...
         this.notification.alertInfo("Phone Number is required")
          ...
          this.notification.alertInfo("Password is required and must be a minimum of 8 characters")
          ...
          this.notification.alertInfo("Passwords do not match")
            ...
            // start is processing
                  //    this.notification.alertInfo("valid")
            ...
            this.rncoService.RegisterAffiliate(data).subscribe((res)=>{
              this.notification.alertSucess("Affiliate Has been added")
