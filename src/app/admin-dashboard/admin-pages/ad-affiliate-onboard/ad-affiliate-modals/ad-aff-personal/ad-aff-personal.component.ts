...
@Component({
selector: 'app-ad-aff-personal',
templateUrl: './ad-aff-personal.component.html',
styleUrls: ['./ad-aff-personal.component.scss']
})
export class AdAffPersonalComponent implements OnInit {
// hide password
hidePassword = true;
...
validateForm(currentValue: any){
  ...
  if (!this.login && !this.firstName && !this.lastName && !this.phoneNumber && !this.email && !this.dateOfBirth) {
     ...
     // start is processing
       const data = {
        ...
        this.rncoService.AdminCreateAffiliate(data).subscribe((res)=>{
          console.log(res);
          // pass details
          ...
          this.notification.alertSucessAffiliate()
          // move to next 
