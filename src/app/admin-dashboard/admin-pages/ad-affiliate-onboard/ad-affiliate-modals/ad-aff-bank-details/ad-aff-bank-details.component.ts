...
@Component({
selector: 'app-ad-aff-bank-details',
templateUrl: './ad-aff-bank-details.component.html',
styleUrls: ['./ad-aff-bank-details.component.scss']
})
export class AdAffBankDetailsComponent implements OnInit {
